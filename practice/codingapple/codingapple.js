...
const 답 = ["a","p","p","l","e"]
console.log(답);
let inputEvent = document.querySelectorAll('.input');
...
document.querySelector('button').addEventListener('click',
  function () {
    ...
    console.log("temp",temp, JSON.stringify(temp),답,  JSON.stringify(temp) == JSON.stringify(답));
    if(JSON.stringify(temp) == JSON.stringify(답)) {
      alert("정답입니다");
      location.reload();
      return;
    }
